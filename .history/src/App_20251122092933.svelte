...
<style>
  /* Global Styles giả lập (Vì chúng ta dùng Svelte scope) */
  ...
  .tab-btn { flex: 1; border: none; background: transparent; cursor: pointer; display: flex; flex-direction: column; align-items: center; gap: 3px; color: #bbb; outline: none; }
