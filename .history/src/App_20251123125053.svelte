<script>
  ...
  const tourSteps = [
    { target: '.app-header', title: 'Xin chào!', content: 'Đây là trung tâm điều khiển của bạn. Bấm vào Avatar để xem thông tin, nút (?) để xem lại hướng dẫn này.' },
    { target: '.tab-nav', title: 'Chọn Bộ Phận', content: 'Chuyển đổi linh hoạt giữa Checklist Kho, Thu Ngân và Bàn Giao ca trực.' },
    { target: '.content-area', title: 'Danh sách việc', content: 'Các đầu việc sẽ hiện ở đây. Màu cam là Kho, Xanh là Thu ngân. Bấm vào việc để hoàn thành.' },
    { target: 'footer', title: 'Thông tin Kho', content: 'Hiển thị mã kho bạn đang làm việc. Nếu quản lý nhiều kho, mã kho sẽ hiện cạnh tên công việc.' }
  ];
