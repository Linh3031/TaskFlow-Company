...
<style>
  /* 1. ÉP BUỘC KHAI BÁO FONT ICON NGAY TẠI ĐÂY ĐỂ SỬA LỖI */
  .material-icons-round {
    font-family: 'Material Icons Round';
    font-weight: normal;
    font-style: normal;
    font-size: 24px; /* Kích thước chuẩn */
  ...
  /* Chỉnh lại size icon logo cho to đẹp */
  .brand-logo .material-icons-round { font-size: 32px; }
  ...
  /* QUAN TRỌNG: Padding trái 45px để chữ không đè lên icon */
  .input-field { 
    width: 100%; 
