      ...
      <div class="flex-1 text-left">
        <div class="text-sm font-semibold text-gray-800 leading-snug">
            {#if showStoreBadge && task.storeId}
                <span class="inline-block bg-indigo-100 text-indigo-700 text-[10px] px-1.5 py-0.5 rounded mr-1 font-bold tracking-wider align-middle border border-indigo-200">
                    {task.storeId}
                </span>
            {/if}
