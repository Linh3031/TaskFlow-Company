<script>
  // Version 40.0 - Add Cumulative History View
...
<div class="flex items-center justify-between mb-3 px-1">
    ...
    {#if scheduleData}
        <div class="flex gap-2">
            <button class="flex items-center gap-2 bg-indigo-50 text-indigo-700 px-3 py-1.5 rounded-lg font-bold text-xs shadow hover:bg-indigo-100 transition-all border border-indigo-100" on:click={() => showHistoryModal = true} title="Xem lịch sử giờ công các tháng trước">
