...
<div class="flex flex-wrap items-center justify-between mb-3 px-1 gap-2">
    ...
    <div class="flex items-center justify-between w-full lg:w-auto gap-2 shrink-0">
    ...
    <div class="flex items-center gap-1.5 w-full lg:w-auto overflow-x-auto pb-1 sm:pb-0 hide-scrollbar justify-start lg:justify-end">
